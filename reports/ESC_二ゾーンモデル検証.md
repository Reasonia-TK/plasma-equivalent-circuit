...
- `ne,W = 2.469388179394e14 m^-3`
- `ne,F = 2.469388179185e14 m^-3`
- `Te,W = 4.78512417567 eV`
- `Te,F = 4.78512417561 eV`
- 粒子数保存誤差：`0.0`
- 電子エネルギー保存相対誤差：`1.29e-16`
- 最終密度不均一度：`8.47e-11`
- 最終温度不均一度：`1.24e-11`
...
- 五条件すべてで計算完了。
- 全電力収支の最大相対残差：`2.92e-4`（`0.0292%`）。
- 最終二周期の最大 L2 差：`1.75e-4`。
...
| 粒子保存 | `<1e-12` | `0` | 合格 |
| 電子エネルギー保存 | `<1e-12` | `1.29e-16` | 合格 |
| 強交換の均一化 | `ne,Te` 不均一度 `<1e-6` | `<1e-10` | 合格 |
| 回路電力収支 | `<0.1%` | 最大 `0.0292%` | 合格 |
| RF周期定常 | L2差 `<2e-4` | 最大 `1.75e-4` | 合格 |
